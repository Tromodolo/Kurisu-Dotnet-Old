...
namespace KatBot.Modules.Owner
{
    [Name("Owner")]
    public class OwnerModule : InteractiveModuleBase<ICommandContext>
    {
        ...
        public async Task Die()
        {
            ...
            await Katarina.client.StopAsync();
            Environment.Exit(0);
        }
        ...
        public async Task SetAvatar(string AvatarURL = null)
        {
            ...
            try
            {
                using (var stream = await http.GetStreamAsync(AvatarURL))
                {
                    ...
                    await Katarina.client.CurrentUser.ModifyAsync(u => u.Avatar = new Image(imgStream))
        ...
        public async Task SetGame([Remainder] string Game = null)
        {
            ...
            await Katarina.client.SetGameAsync(Game);
        ...
        public async Task SetName([Remainder] string Name = null)
        {
            ...
            try
            {
                await Katarina.client.CurrentUser.ModifyAsync(x => x.Username = Name);
        ...
        {
            IGuild Hangout = Katarina.client.Guilds.Single(x => x.Id == 331573354291265548);
