...
namespace KatBot.Modules.Moderation
{
    [Name("Moderation")]
    public class ModerationModule : InteractiveModuleBase<ICommandContext>
    {
        ...
        public async Task setrole([Remainder] IRole role)
        {
            ...
            try
            {
                ...
                {
                    await Katarina.db.addRole(role);
        ...
        public async Task unsetRole([Remainder] IRole role)
        {
            ...
            if (await Katarina.db.checkServerRole(role))
            {
                await Katarina.db.removeRole(role);
        ...
        {
            await Katarina.db.updateServerprefix(Context.Guild, prefix);
