...
using KurisuBot.Database;
using KurisuBot.Modules.Music;
...
namespace KurisuBot
{
    internal class Kurisu
    {
        ...
        public static Color KurisuClr = new Color(242, 78, 46); //Color to use in embeds 
        ...
        {
                new Kurisu().MainAsync().GetAwaiter().GetResult();
        }
