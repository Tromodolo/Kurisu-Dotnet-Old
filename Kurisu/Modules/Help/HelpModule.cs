...
namespace KurisuBot.Modules.Help
{
    [Name("Help")]
    public class HelpModule : InteractiveModuleBase<ICommandContext>
    {
        ...
        public async Task Commands()
        {
            ...
            foreach (var m in Kurisu.commandHandler.Commands.Modules)
            {
            ...
            var Author = new EmbedAuthorBuilder().WithName(Kurisu.client.CurrentUser.Username)
                .WithIconUrl(Kurisu.client.CurrentUser.GetAvatarUrl());
